...
def update_note(note):  # Создаём функцию по выбору и обновлению какой-либо заметки
    while True:
        print('Какое поле заметки вы хотите обновить ?')
        print('1. Имя', '2. Заголовок', '3. Описание', '4. Статус', '5. Дата дедлайна', sep='\n')
        marker = input('Выберите заменяемое поле, набрав соответствующую цифру: ')
        if marker == '1':
